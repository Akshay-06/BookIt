...
public class BookDaoJdbc implements BookDao {
    //To retrieve books based on book_id
    ...
    //To retrieve books based on category_id
    ...
    //To retrieve random books based on category_id and limit parameter
    ...
    public List<Book> findByCategoryId(long categoryId) {
        ...
        try (Connection connection = JdbcUtils.getConnection();
            ...
            throw new BookstoreQueryDbException("Encountered a problem finding books in " + categoryId, e);
        }
        return books;
    }
